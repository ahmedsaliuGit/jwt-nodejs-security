...
class UserController {
  ...
  static getOneById = async (
    ...
    // Restrict USER requestors to retrieve their own record.
  ...
  static editUser = async (req: Request, res: Response, next: NextFunction) => {
    ...
    // Restrict USER requestors to edit their own record.
    ...
    // Do not allow USERs to change themselves to an ADMIN.
